  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* This site's chrome (Header/Footer) is intentionally dark and relies on
          ...
          any DS component consumed here (e.g. FieldLabel/IconTile on /contact)
          ...
          fixes this at the root; this port makes #1174 green independently of
          which of the two merges first. */}
