...
const industries: Industry[] = [
  {
    ...
    products: ['FuzeKeys (identity & access)', 'FuzeSDLC (audited governance)', 'FuzeQuality (compliance coverage)'],
  ...
  },
  {
    ...
    products: ['FuzeKeys (PHI-safe identity)', 'FuzeFront (RBAC)', 'FuzeQuality (compliance gates)'],
  ...
  },
  {
    ...
    description: 'From checkout flows to catalog UX, FuzeOne gives e-commerce teams the shared auth, design review, and quality automation to ship storefront features fast without breaking conversion.',
    challenges: [
      'Scaling auth and access across storefronts and admin tools',
      'Shipping UI changes without regressing conversion-critical flows',
      'Reviewing checkout and catalog UX before it ships',
      'Coordinating fast-moving product and engineering teams',
    ],
    products: ['FuzeKeys (storefront identity)', 'FuzeQuality (checkout regression coverage)', 'FuzeX (conversion-flow review)'],
  ...
  },
  {
    ...
    products: ['FuzeKeys (secrets & access)', 'FuzeSDLC (immutable audit trail)', 'FuzeQuality (compliance coverage)'],
  ...
  },
  {
    ...
    products: ['FuzeFront (multi-tenant)', 'FuzeAgent (AI tutoring workflows)', 'FuzeQuality (FERPA compliance coverage)'],
  ...
  },
  {
    ...
    challenges: [
      'Multi-tenant auth from day one',
      'Module Federation for extensible UIs',
      'Standing up production-grade infra without a platform team',
      'Shipping releases across multiple cloud environments',
    ],
    products: ['FuzeFront (Module Federation)', 'FuzeInfra (shared data & infra)', 'FuzeDeploy (multi-cloud CI/CD)'],
  ...
  },
  {
    ...
    description: 'Agencies need to move fast across projects and clients. FuzeOne gives your team reusable infrastructure, shared design review, and AI-assisted delivery that multiply output without multiplying headcount.',
    challenges: [
      'Reusable auth infrastructure per client project',
      'Tracking planning and delivery across many concurrent clients',
      'Getting client sign-off on UX before engineering starts',
      'Scaling delivery output without scaling headcount',
    ],
    products: ['FuzePlan (multi-client tracking)', 'FuzeX (client UX approvals)', 'FuzeAgent (AI-assisted delivery)'],
  ...
  },
  {
    ...
    products: ['FuzeKeys (enterprise SSO)', 'FuzeInfra (private cloud deploys)', 'FuzeSDLC (governance & compliance)'],
