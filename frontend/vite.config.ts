...
// Resolve the @fuzeone/* workspace UI packages from SOURCE rather than from a
// published registry build. @fuzeone/identity-ui is an unpublished local
// workspace package whose ./dist is not built in CI, and @fuzeone/design-system
...
// @fuzeone/auth-ui (AuthPanel, consumed by LoginPage.tsx) is an unpublished
...
// since it is TSX and imports @fuzeone/design-system.
...
// @fuzeone/chat-client and @fuzeone/chat-ui are file: workspace packages whose
...
// @fuzeone/billing-ui (packages/billing-ui) + @fuzeone/billing-client (top-level
...
// @fuzeone/app-registry-client (apps-client/) is an unpublished file: workspace
...
// @fuzeone/security-client (packages/security/) is the generated, provider-
...
// @fuzeone/portal-client (top-level portal-client/) is the generated portal
// API client + contract types (contract-designer, FF-EPIC-10) and
// @fuzeone/portal-branding-ui (packages/portal-branding-ui) is the white-label
...
// @fuzeone/account-security-ui (packages/account-security-ui) is an unpublished
...
export default defineConfig({
  resolve: {
    alias: {
      ...
      // Exact stylesheet subpath must precede the bare '@fuzeone/chat-ui' alias.
      '@fuzeone/chat-ui/styles.css': chatUiStyles,
      '@fuzeone/chat-ui': chatUiSrc,
      '@fuzeone/chat-client': chatClientSrc,
      ...
      // DIRECTORY and precede the exact alias, else `@fuzeone/design-system/styles.css`
      // resolves under the index.js FILE → ENOTDIR. main.tsx imports the stylesheet.
      '@fuzeone/design-system/': `${designSystemDir}/`,
      '@fuzeone/design-system': designSystemSrc,
    },
    // @fuzeone/i18n is bundled from source and pulls react-i18next (which has a
  ...
  plugins: [
    ...
    federation({
      ...
      // UI packages (@fuzeone/identity-ui, @fuzeone/design-system,
      // @fuzeone/chat-ui) resolve from source/workspace; listing them here makes
