...
// @fuzefront/billing-ui and @fuzefront/billing-client are file: workspace packages
// whose dist/ is not built in CI — resolve from source, same as identity-ui/chat-ui.
