 ...
 */
export declare function assignRoleInPermit(
  assignment: RoleAssignment
): Promise<boolean>
/**
 * Unassigns a role from a user in an organization (tenant)
 */
export declare function unassignRoleInPermit(
  assignment: Omit<RoleAssignment, 'resource_instance'>
): Promise<boolean>
/**
 * Lists all role assignments for a user
 */
export declare function getUserRoleAssignments(
  userId: string,
  tenantId?: string
): Promise<import('permitio').RoleAssignmentRead[]>
/**
 * Lists all role assignments in a tenant
 */
export declare function getTenantRoleAssignments(
  tenantId: string
): Promise<import('permitio').RoleAssignmentRead[]>
/**
 ...
 */
export declare function assignOrganizationRole(
  userId: string,
 ...
 */
export declare function updateOrganizationRole(
  userId: string,
  organizationId: string,
  oldRole: string,
  newRole: string
