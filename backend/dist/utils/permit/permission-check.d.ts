 ...
 */
export declare function bulkCheckPermissions(
  checks: PermissionCheck[]
): Promise<boolean[]>
/**
 * Checks organization-level permissions
 */
export declare function checkOrganizationPermission(
  userId: string,
 ...
 */
export declare function checkAppPermission(
  userId: string,
 ...
 */
export declare function checkUserManagementPermission(
  userId: string,
 ...
 */
export declare function checkOrganizationAccess(
  userId: string,
  organizationId: string
): Promise<boolean>
/**
...
export declare function getUserPermissions(
  ...
  import('permitio/build/main/enforcement/interfaces').IUserPermissions
>
/**
