 ...
 */
export declare function bulkSyncTenants(organizations: Organization[]): Promise<{
    success: number;
    failed: number;
}>;
/**
 ...
 */
export declare function bulkAssignRoles(assignments: RoleAssignment[]): Promise<{
    success: number;
    failed: number;
}>;
/**
 ...
 */
export declare function setupOrganizationWithRoles(organization: Organization, membershipData: Array<{
    userId: string;
