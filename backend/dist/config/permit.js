...
exports.permitConfig = exports.isNoOpMode = void 0;
exports.destroyPermitClient = destroyPermitClient;
...
exports.isNoOpMode = CI_DUMMY_KEYS.has(config.token) ||
 ...
 */
function destroyPermitClient() {
    try {
        if (!exports.isNoOpMode) {
            // Real SDK: also tear down the SDK's own axios instance agents.
            const axiosInstance = permit?.config?.axiosInstance;
