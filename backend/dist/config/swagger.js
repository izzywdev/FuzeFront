                ...
                App: {
                    ...
                    properties: {
                        ...
                        remoteUrl: {
                            type: 'string',
                            format: 'uri',
                            description: 'URL to the Module Federation remote entry (for module-federation type)',
                        },
                        scope: {
                            type: 'string',
                            description: 'Module Federation scope name (for module-federation type)',
                        },
                        module: {
                            type: 'string',
                            description: 'Module Federation exposed module path (for module-federation type)',
                        },
                        description: {
                            type: 'string',
                ...
                CreateAppRequest: {
                    ...
                    properties: {
                        ...
                        remoteUrl: {
                            type: 'string',
                            format: 'uri',
                            description: 'URL to the Module Federation remote entry (required for module-federation)',
                        },
                        scope: {
                            type: 'string',
                            description: 'Module Federation scope name (required for module-federation)',
                        },
                        module: {
                            type: 'string',
                            description: 'Module Federation exposed module path (required for module-federation)',
                        },
                        description: {
                            type: 'string',
