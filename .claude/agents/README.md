...
- **agile-manager** — delivery coordination only: **Atlassian** (Jira/Confluence tickets, sprints, status) + **Slack** (team comms) + cross-repo `@fuze` delegation tracking. Writes tickets/reports, never product code.
