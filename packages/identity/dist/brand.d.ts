...
export declare class IdentityError extends Error {
    readonly code: 'PREFIX_MISMATCH' | 'MALFORMED_ID' | 'UNKNOWN_PREFIX' | 'LEGACY_NOT_PERMITTED';
    readonly expectedType: EntityType;
    constructor(code: IdentityError['code'], expectedType: EntityType, message: string);
}
export {};
