...
// Mirrors the same allow-marked constant in frontend/src/pages/LoginPage.tsx.
const GOOGLE_BRAND = {
...
/** The official Google "G" mark, inlined so the vanilla build stays zero-dependency. */
