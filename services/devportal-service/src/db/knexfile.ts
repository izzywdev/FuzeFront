// knexfile.ts — Knex configuration for devportal-service.
//
...
// Role: devportal_svc  Database: fuzefront_devportal
...
const connectionFromEnv = (): Knex.PgConnectionConfig => ({
  ...
  database: process.env.DB_NAME || 'fuzefront_devportal',
  user: process.env.DB_USER || 'devportal_svc',
